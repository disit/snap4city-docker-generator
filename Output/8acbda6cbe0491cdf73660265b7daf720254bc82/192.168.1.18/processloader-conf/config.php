...
$oicd_address='http://zjyzfjjy';
$ssoEndpoint = 'http://zjyzfjjy';
$ssoClientId = 'php-dashboard-builder';
$ssoClientSecret = 'fd4b64fc-eabd-41e8-aef4-34c9f6864b2c';
$personalDataApiBaseUrl = 'http://zjyzfjjy/ownership-api';
$delegationDataApiUrl = 'http://zjyzfjjy/datamanager/api';
$ldapParamters = 'dc=ldap,dc=organization,dc=com';
$access_token_userinfo = 'http://zjyzfjjy/auth/realms/master/protocol/openid-connect/userinfo';
$appUrl= 'http://zjyzfjjy/processloader';
