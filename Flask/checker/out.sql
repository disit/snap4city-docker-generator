...
INSERT INTO `complex_tests` VALUES (3,'Read parameters','bash scripts/read_params.sh','string:username:u;number:age:a;string:fullname:f','#000000','This tests simply ensures that passing parameters works'),
