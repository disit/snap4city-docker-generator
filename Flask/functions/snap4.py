...
def docker_to_kubernetes(location, hostname, namespace, final_path='/mnt/data/generated', placeholders={},ip="127.0.0.1", is_https=False, somemoreconf = {}):
    ...
    if "nifi-amount" in somemoreconf.keys():
        nifiyaml["spec"]["replicas"] = somemoreconf["nifi-amount"]
    ...
    for i, j in enumerate(origs):
        #print("debugging: old was", location+'/kubernetes_eks'+os.sep+str(j['spec']['template']['spec']['containers'][0]['name'])+'-deployment-new.yaml')
