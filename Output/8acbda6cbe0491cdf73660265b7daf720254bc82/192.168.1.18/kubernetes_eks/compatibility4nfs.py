...
for orig in origs:
    ...
    if orig['spec']['template']['spec']['containers'][0]['name']=='virtuoso-kb':
        ...
        orig['spec']['template']['spec']['containers'][0]['readynessProbe']={'exec':{'command':'["/bin/sh", "-c", "./bin/nifi.sh set-single-user-credentials admin evu17GUFxl50f6Jw"]'},'initialDelaySeconds':25,'timeoutSeconds':30,'periodSeconds': 1000000000}
