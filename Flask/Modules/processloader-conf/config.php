...
$oicd_address='$#base-url#$';
$ssoEndpoint = '$#base-url#$';
$ssoClientId = 'php-dashboard-builder';
$ssoClientSecret = 'fd4b64fc-eabd-41e8-aef4-34c9f6864b2c';
$personalDataApiBaseUrl = '$#base-url#$/ownership-api';
$delegationDataApiUrl = '$#base-url#$/datamanager/api';
$ldapParamters = '$#ldap-base-dn#$';
$access_token_userinfo = '$#base-url#$/auth/realms/master/protocol/openid-connect/userinfo';
$appUrl= '$#base-url#$/processloader';
...
$colormap_external_link = '$#base-url#$/dashboardSmartCity/img/';
