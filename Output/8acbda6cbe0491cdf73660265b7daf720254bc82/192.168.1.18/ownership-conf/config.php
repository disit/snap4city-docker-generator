...
$database = "profiledb";
$db_user = "user";
$db_pwd = "I8YfiHfBqq7BNFXM";

// SSO configuration (needed only for debugging)
$sso_base_url = 'http://zjyzfjjy/auth/';
$sso_client_id = 'php-ownership-api';
$sso_client_secret = '7bcdc43f-210d-45cc-9b5f-f1025bba525f';
$sso_login_redirect = 'http://zjyzfjjy/ownership-api/login/';
// SSO mandatory configuration
$sso_userinfo_endpoint = 'http://zjyzfjjy/auth/realms/master/protocol/openid-connect/userinfo';
...
$keycloack_base_url = 'http://zjyzfjjy/auth';
$keycloack_admin = 'admin';
$keycloack_pwd = 'goDmZTNluIRwUuBS';
...
$datamanager_api_url = 'http://zjyzfjjy/datamanager/api';
